...
public class NaviPage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(HomeData.getListData(), this);
        recyclerView.setAdapter(adapter);
        ImageView imageView = (ImageView) (findViewById(R.id.loft_banner));
        imageView.setImageResource(R.drawable.loft9banner);
